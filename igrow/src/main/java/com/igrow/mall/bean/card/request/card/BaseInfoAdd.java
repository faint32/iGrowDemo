...
public class BaseInfoAdd implements Serializable {
...
/*	
	...
	private Boolean canShare = true; //领取卡券原生页面是否可分享，填写true 或false，true 代表可分享。默认可分享。
	
	@XStreamAlias("can_give_friend")
	@JsonProperty("can_give_friend")
	private Boolean canGiveFriend = true; //卡券是否可转赠，填写true 或false,true 代表可转赠。默认可转赠。
