/*
 * @(#)ImagePort.java 2012-3-22下午02:35:24
 * Copyright © 2011-2012 DKDM Inc. All Rights Reserved.
 */
package com.igrow.mall.jws.port;
...
import com.igrow.mall.jws.beans.WaterSetting;
 ...
 * @modificationHistory.  
 * <ul>
 * <li>joe.qiu 2012-3-22下午02:35:24 TODO</li>
 * </ul> 
 */
...
public interface ImagePort extends Serializable{
	...
	public boolean uploadImageByUrl(String folderType, String srcURL, Object destFileId,
			String destFileName, com.igrow.mall.jws.beans.WaterSetting waterSetting) throws IOException;
	/**
	 * 上传默认规格图片方法
	 * 如果选择上传水印,将合成默认水印,水印位置取默认水印位置
	 * @author joe.qiu
