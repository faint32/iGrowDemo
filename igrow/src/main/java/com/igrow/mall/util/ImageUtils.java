...
import com.igrow.mall.jws.beans.ImageState;
...
public class ImageUtils {
	 ...
	 * @return
	 */
	public static List<ImageState> findActiveImgStates(){
		List<ImageState> states = new ArrayList<ImageState>(); 
		//添加生成图片规格的对象
	    ImageState imageState = new ImageState();
	    imageState.setHight(300);
	    imageState.setPreName(ImageConstants.UPLOAD_ACTIVE_INFO_);
	    imageState.setWidth(200);
	    states.add(imageState);
	    
	    ImageState imageState2 = new ImageState();
	    imageState2.setHight(10);
	    imageState2.setPreName(ImageConstants.UPLOAD_ACTIVE_INFO_);
	    imageState2.setWidth(10);
	    states.add(imageState2);
	 ...
	 * @return
	 */
	public static List<ImageState> findProductHotelImgStates(){
		List<ImageState> states = new ArrayList<ImageState>(); 
		//添加生成图片规格的对象
	    ImageState imageState = new ImageState();
	    imageState.setHight(300);
	    imageState.setPreName(ImageConstants.UPLOAD_HOTEL_INFO_);
	    imageState.setWidth(200);
	    states.add(imageState);
		return states;
	}
