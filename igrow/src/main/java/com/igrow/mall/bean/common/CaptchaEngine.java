...
public class CaptchaEngine extends ListImageCaptchaEngine {
	...
	private static final Integer IMAGE_HEIGHT = 50;// 验证码图片高度
	private static final Integer IMAGE_WIDTH = 98;// 验证码图片宽度
	private static final Integer MIN_FONT_SIZE = 20;// 验证码最小字体
	private static final Integer MAX_FONT_SIZE = 24;// 验证码最大字体
	//private static final String RANDOM_WORD = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";// 随机字符
	private static final String RANDOM_WORD = "0123456789";// 随机字符
	private static final String IMAGE_PATH = "./com/igrow/mall/captcha/";// 随机背景图片路径
