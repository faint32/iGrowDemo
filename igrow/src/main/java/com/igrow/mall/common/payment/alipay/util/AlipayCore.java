...
public class AlipayCore {
    ...
    /**
    * @Title createLinkStringNoSort
    * @Description TODO【无顺序添加】
    * @param params
    * @return 
    * @Return String 返回类型
    * @Throws 
    */ 
    public static String createLinkStringNoSort(Map<String, String> params) {
    	...
    	sb.append("&v=");
    	sb.append(params.get("v"));
      	sb.append("&sec_id=");
    	sb.append(params.get("sec_id"));
      	sb.append("&notify_data=");
    	sb.append(params.get("notify_data"));
    	return sb.toString();
    }
